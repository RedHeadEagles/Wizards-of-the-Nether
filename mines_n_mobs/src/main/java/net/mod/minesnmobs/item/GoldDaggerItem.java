...
public class GoldDaggerItem extends MinesNMobsModElements.ModElement {
	@ObjectHolder("mines_n_mobs:gold_dagger")
	public static final Item block = null;
	public GoldDaggerItem(MinesNMobsModElements instance) {
		super(instance, 4);
	}
